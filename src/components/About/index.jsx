...
const About = () => {
  return (
    <div className='block'>
      ...
      <div>Noori Qudsi Academy is a Masjid in Manteca, committed to serving the Muslim community through the authentic teachings and traditions of Ahl as-Sunnah wal-Jamāʻah.</div>
